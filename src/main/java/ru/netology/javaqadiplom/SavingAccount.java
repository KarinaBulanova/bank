...
public class SavingAccount extends Account {
    ...
    public SavingAccount(int initialBalance, int minBalance, int maxBalance, int rate) {
        ...
        if (minBalance == maxBalance) {
            throw new IllegalArgumentException(
                    "Минимальный баланс не может быть равен максимальному балансу , а у вас: " + rate
            );
        }
        ...
        if (maxBalance <= 0) {
            throw new IllegalArgumentException(
                    "Максимальный баланс не может быть меньше или равен 0, а у вас: " + maxBalance
            );
        }
        if (minBalance > maxBalance) {
            throw new IllegalArgumentException(
                    "Минимальный баланс не может быть больше минимального, а у вас: " + minBalance
            );
        }
